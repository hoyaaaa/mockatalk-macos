...
if [[ "${1:-}" != "--yes" ]]; then
  echo "This will remove /Applications/카카오톡Sub.app, LaunchAgent, updater helper files, and com.hoyaaaa.KakaoTalkSub user data."
